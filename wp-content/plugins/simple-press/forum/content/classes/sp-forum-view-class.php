...
Simple:Press
Forum View Class
$LastChangedDate: 2015-07-09 03:45:38 -0700 (Thu, 09 Jul 2015) $
$Rev: 13087 $
*/
...
class spForumView {
	...
	function sp_forumview_subforums_query($subs, $top = false) {
		...
		$spdb = new spdbComplex;
			$spdb->table	= SFFORUMS;
			$spdb->fields	= 'forum_id, forum_name, forum_slug, forum_desc, forum_seq, forum_status, forum_disabled, forum_icon, forum_icon_new, topic_icon, topic_icon_new, topic_icon_locked, topic_icon_pinned, forum_rss_private,

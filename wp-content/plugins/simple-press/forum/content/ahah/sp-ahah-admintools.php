...
$LastChangedDate: 2015-11-26 12:30:35 -0800 (Thu, 26 Nov 2015) $
$Rev: 13614 $
*/
	...
	<div id="spMainContainer" class="spForumToolsPopup">
		...
		<form action="<?php echo sp_build_url($thisforum->forum_slug, '', 1, 0); ?>" method="post" name="movetopicform">
			...
			<div class="spCenter">
				...
				<input type="button" class="spSubmit" name="cancel" value="<?php sp_etext('Cancel') ?>" onclick="<?php echo(sp_cancel_script()); ?>" />
			</div>
		</form>
	</div>
<?php
...
function sp_edit_title_popup() {
	...
	$out.= '<input type="button" class="spSubmit" name="cancel" value="'.sp_text('Cancel').'" onclick="'.sp_cancel_script().'" />';
	...
	<div id="spMainContainer" class="spForumToolsPopup">
		...
		<form action="<?php echo sp_build_url($thisforum->forum_slug, $thistopic->topic_slug, 1, 0); ?>" method="post" name="movepostform">
			...
			<fieldset><legend><?php sp_etext('Select Operation'); ?></legend>
				...
				<input type="button" class="spSubmit" name="cancel" value="<?php echo sp_splice(sp_text('Cancel Move'), 0) ?>" onclick="<?php echo(sp_cancel_script()); ?>" />
				</span>
...
?>
				<tr><td class="spLabel" style="width:85%"><?php echo sp_filter_title_display($topic->topic_name); ?>
				<input type="hidden" name="topicid[]" value="<?php echo $topic->topic_id; ?>" /></td>
				<td class="spControl">
					<input type="text" class="spControl" size="6" name="porder[]" value="<?php echo $topic->topic_pinned; ?>" />
				</td>
<?php
			}
?>

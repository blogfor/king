...
function sp_render_add_post_form($args) {
	...
	$out.= "<form class='$tagClass' action='".SFHOMEURL."index.php?sp_ahah=post&amp;sfnonce=".wp_create_nonce('forum-ahah')."' method='post' id='addpost' name='addpost' onsubmit='return spjValidatePostForm(this, $spThisUser->guest, 0, \"".sp_paint_file_icon(SPTHEMEICONSURL, 'sp_Success.png')."\");'>\n";

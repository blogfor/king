...
Simple:Press
Admin plugins list
$LastChangedDate: 2015-10-27 03:49:44 -0700 (Tue, 27 Oct 2015) $
$Rev: 13527 $
*/
...
function sp_paint_plugin_tip($name, $file) {
	...
	$out = '<br />';
	$out.= '<a href="javascript:void(null)" class="spLinkHighlight" onclick="spjDialogAjax(this, \''.$site.'\', \''.$htitle.'\', 400, 0, 0);"><b>'.$atitle.'</b></a>';
	return $out;
}

    	...
    	new AjaxUpload(button,{
    		...
    		onComplete: function(file, response){
    			...
    			if (response==="success"){
    				...
    				jQuery('<table id="icon' + icount + '" style="width:100%"></table>').appendTo('#sf-custom-icons').html('<tr><td class="spWFBorder" style="text-align:center;width:30%"><img class="sfcustomicon" src="<?php echo SFCUSTOMURL; ?>/' + file + '" alt="" /></td><td class="spWFBorder sflabel" style="text-align:center;width:50%">' + file + '</td><td class="spWFBorder" style="text-align:center"><img src="<?php echo SFCOMMONIMAGES; ?>' + 'delete.png' + '" title="<?php echo esc_js(spa_text('Delete custom icon')); ?>" alt="" onclick="spjDelRow(\'' + site + '\', \'icon' + icount + '\');" /></td></tr>');

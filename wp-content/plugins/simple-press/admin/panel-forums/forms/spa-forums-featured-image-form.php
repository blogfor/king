    	...
    	new AjaxUpload(button,{
    		...
    		onComplete: function(file, response){
    			...
    			if (response==="success"){
    				...
    				jQuery('<table style="width:100%"></table>').appendTo('#sf-featured-images').html('<tr><td style="width:60%;text-align:center"><img class="sffeaturedimage" src="<?php echo SFFEATUREDURL; ?>/' + file + '" alt="" /></td><td class="sflabel" style="text-align:center;width:30%">' + file + '</td><td class="sflabel" style="text-align:center;width:9%"><img src="<?php echo SFCOMMONIMAGES; ?>' + 'delete.png' + '" title="<?php echo esc_js(spa_text('Delete Feature Image')); ?>" alt="" onclick="spjDelRowReload(\'' + site + '\', \'sfreloadfi\');" /></td></tr>');

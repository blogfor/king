...
$LastChangedDate: 2015-07-03 02:39:04 -0700 (Fri, 03 Jul 2015) $
$Rev: 13068 $
*/
...
function spa_save_forums_create_forum() {
	...
	$sql = 'INSERT INTO '.SFFORUMS.' (forum_name, forum_slug, forum_desc, group_id, forum_status, forum_seq, forum_rss_private, forum_icon, forum_icon_new, forum_icon_locked, topic_icon, topic_icon_new, topic_icon_locked, topic_icon_pinned, feature_image, parent, forum_message, keywords) ';
	$sql.= "VALUES ('".$forumdata['forum_name']."', '".$forumslug."', '".$forumdata['forum_desc']."', ".$forumdata['group_id'].", ".$forumdata['forum_status'].", ".$forumdata['forum_seq'].", ".$forumdata['forum_rss_private'].", '".$forumdata['forum_icon']."', '".$forumdata['forum_icon_new']."', '".$forumdata['forum_icon_locked']."', '".$forumdata['topic_icon']."', '".$forumdata['topic_icon_new']."', '".$forumdata['topic_icon_locked']."', '".$forumdata['topic_icon_pinned']."', '".$forumdata['feature_image']."', ".$parentdata.", '".$forumdata['forum_message']."', '".$forumdata['forum_keywords']."');";

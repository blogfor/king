...
Simple:Press
Admin Panels
$LastChangedDate: 2015-11-27 05:52:05 -0800 (Fri, 27 Nov 2015) $
$Rev: 13616 $
*/
...
function spa_panel_header() {
	...
	echo '<input type="button" id="spHelp" class="button-primary" value="'.spa_text('Help and Troubleshooting').'" onclick="spjTroubleshooting(\''.$site.'\', \''.$target.'\');" />&nbsp;&nbsp;&nbsp;';

	echo '<a class="button" target="_blank" href="http://simple-press.com/documentation/codex/">'.spa_text('Simple:Press Codex').'</a>&nbsp;&nbsp;&nbsp;';

	$site = SFHOMEURL.'index.php?sp_ahah=acknowledge&amp;sfnonce='.wp_create_nonce('forum-ahah');
	$title = spa_text('About Simple:Press');

	echo '<a class="button" href="javascript:void(null)" onclick="spjDialogAjax(this, \''.$site.'\', \''.$title.'\', 600, 0, \'center\');">'.$title.'</a>&nbsp;&nbsp;&nbsp;';

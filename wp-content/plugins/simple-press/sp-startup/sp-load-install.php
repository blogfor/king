...
Simple:Press
Installer/Upgrader
$LastChangedDate: 2015-12-08 01:12:47 -0800 (Tue, 08 Dec 2015) $
$Rev: 13654 $
*/
...
if ($current_build < SPBUILD || version_compare($current_version, SPVERSION, '>=') == 1) {
	sp_upgrade_required();
	return;
}
...
?>
		<div class="updated">
			<img class="stayleft" src="<?php echo SFCOMMONIMAGES; ?>sp-mini-logo.png" alt="" title="" />
...
<?php
		...
		$path = SF_PLUGIN_DIR.'/sp-startup/install/resources/versions/'.$f;
		if(file_exists($path)) {
			readfile($path);
		}
?>

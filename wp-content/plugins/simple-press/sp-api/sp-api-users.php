...
Simple:Press
DESC:
$LastChangedDate: 2015-12-15 17:32:09 -0800 (Tue, 15 Dec 2015) $
$Rev: 13698 $
*/
...
?>
	<fieldset>
    <?php if (sp_is_forum_admin($user->ID)) echo '<div class="error"><p>'.spa_text('Warning:  You are about to delete a Simple:Press Admin user. This could have consequences for administration of your forum. Please ensure you really want to do this.').'</p></div>'; ?>

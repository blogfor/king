/*
$LastChangedDate: 2015-12-04 02:13:33 -0800 (Fri, 04 Dec 2015) $
$Rev: 13636 $
*/
/*--------------------------------------------------------------
...
function spjDialogPanel(e, url, dClass) {
	...
	panel.load(url, function() {
		...
		panel.append("<span id='spPanelClose' onclick='jQuery(\"#spMobilePanel\").hide(\"slide\", {direction: \"down\"}, \"slow\"); '></span>");
	});

...
<style type='text/css'>h1{font:normal 30px/30px Cinzel;color:#1e1d1d;}h2{font:bold 24px/36px Cinzel;color:#d84541;}h3{font:normal 20px/22px Cinzel;color:#1e1d1d;}h4{font:normal 14px/18px Arial,Helvetica,sans-serif;color:#1e1d1d;}h5{font:bold 14px/20px Arial,Helvetica,sans-serif;color:#656565;}h6{font:normal 12px/18px Arial,Helvetica,sans-serif;color:#1e1d1d;}.main-holder{font:normal 13px/18px Arial,Helvetica,sans-serif;color:#656565;}.logo_h__txt,.logo_link{font:normal 24px/30px Cinzel;color:#FFFFFF;}.sf-menu>li>a{font:bold 14px/18px Arial,Helvetica,sans-serif;color:#fff;}.nav.footer-nav a{font:normal 12px/18px Arial,Helvetica,sans-serif;color:#0088CC;}</style>
<!--[if (gt IE 9)|!(IE)]><!-->
...
<a href="">Register</a> / <a href="" >Login</a> </div>
<div> love you</div>

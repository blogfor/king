...
<figure class="featured-thumbnail"><a href="?page_id=43" title="NEWS LETTER"><img src="<?php echo get_template_directory_uri(); ?>/images/ico1.png" alt="join  our university"/></a></figure>
<div class="desc"><h5><a href="?page_id=43" title="NEWS LETTER">NEWS LETTER</a></h5><a href="?page_id=43" class="btn btn-primary" title="NEWS LETTER">read more</a></div></li>
...
<div class="desc"><h6><a href="?page_id=47" title="ANNOUNCEMENTS">ANNOUNCEMENTS</a></h6><a href="?page_id=47" class="btn btn-primary" title="ANNOUNCEMENTS">read more</a></div></li>
<li class="es-carousel_li ">
...
<li class="es-carousel_li "><figure class="featured-thumbnail"><a href="?page_id=51" title="Lorem ipsum"><img src="<?php echo get_template_directory_uri(); ?>/images/ico5-58x64.png" alt="WANT TO DONATE"/></a></figure>
<div class="desc"><h5><a href="?page_id=51" title="WANT TO DONATE">WANT TO DONATE</a></h5><a href="?page_id=51" class="btn btn-primary" title="Lorem ipsum">read more</a></div></li></ul></div></div><script>
